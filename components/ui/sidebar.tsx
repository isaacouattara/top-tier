...
function SidebarInset({
  ...
  if (childArray.length > 1) {
    const [headerChild, ...contentChildren] = childArray;

    return (
      <main
        data-slot="sidebar-inset"
        className={cn(
          "relative flex h-[97vh] w-full flex-1 flex-col overflow-hidden md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
          className,
        )}
        {...props}
      >
        <div className="relative m-2 mb-2 overflow-visible z-50">
          {headerChild}
        </div>

        <div className="z-40 m-2 mt-0 flex-1 min-h-0 overflow-hidden rounded-lg border border-zinc-200/70 bg-white/80 shadow-[0_18px_45px_-24px_rgba(15,23,42,0.35)] backdrop-blur-xl dark:border-zinc-800/70 dark:bg-[#111318]/80">
  ...
  return (
    <main
      data-slot="sidebar-inset"
      className={cn(
        "relative flex h-[97vh] w-full flex-1 flex-col overflow-hidden bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className,
      )}
      {...props}
    >
